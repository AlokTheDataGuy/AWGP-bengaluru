 ...
 *
 * Props: title, subtitle, children (extra CTAs), className
 */
  ...
  return (
    <section className={`page-hero ${className}`.trim()}>
      ...
      <div className="page-hero__inner">
        <h1 className="page-hero__title anim-fade-up">
          {title}
        </h1>
        ...
        {children && (
          <div className="page-hero__extra anim-fade-up" style={{ animationDelay: '0.4s' }}>
            {children}
          </div>
        )}
      </div>

...
const row1 = [
  ...
  { src: '/assets/activities/tree-plantation.jpg',    en: 'Tree Plantation Drives', hi: 'वृक्षारोपण अभियान',   kn: 'ವೃಕ್ಷಾರೋಪಣ ಅಭಿಯಾನ' },
...
const row2 = [
  ...
  { src: '/assets/activities/book-fair.jpg',          en: 'Book Exhibitions',   hi: 'पुस्तक प्रदर्शनी',    kn: 'ಪುಸ್ತಕ ಪ್ರದರ್ಶನ' },
